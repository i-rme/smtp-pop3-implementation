...
public class Mailbox {
	...
	public void createDatabase(String username){
		...
		Mail mail2 = new Mail("The groupwork", "AndresCoworker@gmail.com", username+"@gmail.com","How about do a meeting this weekend? I only can these days");
		Mail mail3 = new Mail("Electric bill", "ENDESA@gmail.com", username+"@gmail.com","You have to pay 5000$ if u want to keep ur internet on");
		Mail mail4 = new Mail("About Covid-19", "USJ@gmail.com", username+"@gmail.com","Get the kids out of the house, we no longer have covid19, now covid20");
		Mail mail5 = new Mail("New hamburguers!", "BurguerQueen@gmail.com", username+"@gmail.com","New burger with papaya flavor");
